...
model = dict(
    ...
    rgb_completion=dict(
        ...
        loss_g=dict(
                ...
                loss_rec=dict(type='smoothl1loss', loss_weight=10.0),
                loss_vgg=dict(type='smoothl1loss', loss_weight=1.0)
            )
        ),
    # mask_gan=dict(
    #     type='MASK_GAN',
...
data_root = '/media/imi-yujun/579e63e9-5852-43a7-9323-8e51241f5d3a/chuanxia/VIV/dataset/'
img_norm_cfg = dict(
...
test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(type='LoadAnnotations', with_bbox=True, with_label=True, with_mask=True, with_seg=False, poly2mask=False,
         with_depth=False, with_f_bbox=True, with_f_mask=False, with_f_rgb=False, with_f_depth=False,
